  ...
  return (
    ...
    >
      <ProSidebar collapsed={isCollapsed}>
        {/* collapsed속성 >>사이드바의 축소 상태를 제어하기 위해 사용 */}
        <Menu iconShape="square">
          {/* LOGO AND MENU ICON */}
          {/* 클릭 시 isCollapsed를 false나 true로 변경 */}
          <MenuItem
          ...
          {/* isCollapsed가 false일 경우 사용자 정보를 화면에 보여준다. */}
          {!isCollapsed && (
            <Box mb="25px">
          ...
          <Box paddingLeft={isCollapsed ? undefined : '10%'}>
            ...
            <Item
              ...
              //아이콘을 그림으로 가져올때
              // icon={isCollapsed ? '유저' : <PeopleOutlinedIcon />}
              // 아이콘을 글자로 가져올 때
              selected={selected}
              setSelected={setSelected}
            />
            ...
            <Item
              title="Pie Chart"
              to="/pie"
              icon={<PieChartOutlinedIcon></PieChartOutlinedIcon>}
              selected={selected}
              setSelected={setSelected}
            />
            <Item
